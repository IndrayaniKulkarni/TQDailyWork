...
public class EmployeeObjectInputOutput2 {
	...
	public static void addData(File f) {
		...
		try {
			...
			if (!f.exists()) {
				...
				Employee2 e = new Employee2(101, "Jitendra", 50000.0f);
				oout.writeObject(e);
	...
	public static void readData(File f) {
		try {
			...
			if(f.exists())
			{
				...
				Employee2 emp=(Employee2) ooin.readObject();
	...
	public static void main(String[] args) {
		...
		File f = new File("D:\\ThinkQuoient\\JavaEclipse\\MyFiles\\empData2.txt");
